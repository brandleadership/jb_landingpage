    ...
    if(X(i)) {
        ...
        if(ke.transitions && !ke.reducedMotion) {
            ...
            var o = Qe.getMenuSize.call(this, i),
                s = function t(n) {
                    n.target === r && ["width", "height"].includes(n.propertyName) && (r.style.width = "", r.style.height = "", Te.call(e, r, te, t))
                };
            Le.call(this, r, te, s), r.style.width = "".concat(o.width, "px"), r.style.height = "".concat(o.height, "px")
        }
